from config import Paginator as emoji
...
class PaginatorButton(Button):
    ...
    async def callback(self, interaction: Interaction) -> None:
        ...
        if self.custom_id == emoji.previous:
            ...
            prompt = await interaction.neutral("What page would you like to skip to?")
...
class Paginator(View):
    def __init__(self, ctx: DefaultContext, pages: list[Embed | str]) -> None:
        super().__init__()
